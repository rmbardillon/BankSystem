...
class Ui_change_pin_window(object):
    ...
    def setupUi(self, change_pin_window, user_index, username):
        ...
        self.confirm_button = QPushButton(self.centralwidget, clicked=lambda: self.enter_pressed(user_index, change_pin_window, username))
    ...
    def enter_pressed(self, user_index, change_pin_window, username):
